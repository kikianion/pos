                        ...
                        <li class="dropdown pull-right">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                if ($temp_site_lang == 'english') {
                                    echo '<img class="flag-img" src="' . base_url() . 'assets/img/english_flag.png" />';
                                } elseif ($temp_site_lang == 'spanish') {
                                    echo '<img class="flag-img" src="' . base_url() . 'assets/img/spanish_flag.png" />';
                                } elseif ($temp_site_lang == 'indonesia') {
                                    echo '<img class="flag-img" src="' . base_url() . 'assets/img/indo_flag.png" />';
                                } else {
                                    echo '<img class="flag-img" src="' . base_url() . 'assets/img/english_flag.png" />';
                                }
                                ?>
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a href="<?= base_url() ?>LangSwitch/switchLanguage/english" style="text-decoration: none; color: #00598c;">
                                        <img class="flag-img" src="<?= base_url() ?>assets/img/english_flag.png" /> &nbsp;&nbsp;English
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= base_url() ?>LangSwitch/switchLanguage/spanish" style="text-decoration: none; color: #00598c;">
                                        <img class="flag-img" src="<?= base_url() ?>assets/img/spanish_flag.png" /> &nbsp;&nbsp;Spanish
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= base_url() ?>LangSwitch/switchLanguage/indonesia" style="text-decoration: none; color: #00598c;">
                                        <img  class="flag-img" src="<?= base_url() ?>assets/img/indo_flag.png" /> &nbsp;&nbsp;Indonesia
                                    </a>
                                </li>
                            </ul>
                        </li>
